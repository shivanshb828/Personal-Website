...
export default function ResearchPage() {
  return (
    <div>
      <h1 className="text-5xl font-normal leading-tight mb-6">Research</h1>
      <p className="text-[#666666] leading-[1.8] mb-16 text-[0.9375rem] max-w-lg">
      ...
      <ul className="space-y-0">
        {papers.map((paper, i) => (
          <li key={i} className="border-t border-[#1a1a1a] py-7">
            ...
            <p className="font-mono text-xs text-[#444444] mt-2">{paper.venue}</p>
          </li>
        ))}
      </ul>
    </div>
